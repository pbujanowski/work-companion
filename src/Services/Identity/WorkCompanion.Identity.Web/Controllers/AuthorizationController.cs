...
using WorkCompanion.Identity.Web.Attributes;
...
/// <summary>
/// Handles OAuth 2.0 / OpenID Connect authorization endpoints
/// </summary>
    ...
    public async Task<IActionResult> Authorize()
    {
        ...
        switch (await _applicationManager.GetConsentTypeAsync(application))
        {
            ...
            case ConsentTypes.Explicit
                when authorizations.Count != 0 && !request.HasPromptValue(PromptValues.Consent):
